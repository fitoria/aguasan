...
urlpatterns = patterns('mapeo.views',
    ...
    (r'^proyecto/(?P<id>\d+)/donantes/editar/$', 'donantes_proyecto', {'action': 'editar'}),
    (r'^proyecto/(?P<id>\d+)/donantes/$', 'donantes_proyecto'),
    (r'^proyecto/(?P<id>\d+)/contrapartes/$', 'contrapartes_proyecto'),
    (r'^proyecto/(?P<id>\d+)/contrapartes/editar/$', 'contrapartes_proyecto', {'action': 'editar'}),
    (r'^proyecto/(?P<id>\d+)/departamento/$', 'departamento_proyecto'),
    (r'^proyecto/(?P<id>\d+)/fotos/$', 'fotos_proyecto'),
    (r'^proyecto/(?P<id_proyecto>\d+)/departamento/(?P<id_dept>\d+)/municipio/$', 'agregar_municipio_proyecto'),
    ...
    (r'^proyectos/editar/municipio/(?P<id>\d+)/$', 'editar_municipio_proyecto'),
    (r'^proyectos/departamento/(?P<id_departamento>\d+)/$', 'proyectos_departamento'),
    ...
    (r'^ajax/editar/contraparte/(?P<id>\d+)/$', 'editar_contraparte_proyecto'),
    ...
    (r'^ajax/editar/donante/(?P<id>\d+)/$', 'editar_donante_proyecto'),
    ...
    (r'^ajax/conteo/proyectos/municipio/(?P<id>\d+)/$', 'conteo_proyectos_municipio'),
    (r'^ajax/conteo/proyectos/departamento/(?P<id>\d+)/$', 'conteo_proyectos_departamento'),
    (r'^ajax/ubicacion/donante/(?P<id>\d+)/$', 'ubicacion_proyecto', {'model': Donante}),
    (r'^ajax/ubicacion/contraparte/(?P<id>\d+)/$', 'ubicacion_proyecto', {'model': Contraparte}),
)
