...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProyectoFotos'
        db.create_table('mapeo_proyectofotos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mapeo.Proyecto'])),
            ('foto', self.gf('mapeo.thumbs.ImageWithThumbsField')(max_length=100)),
        ...
        db.send_create_signal('mapeo', ['ProyectoFotos'])


    def backwards(self, orm):
        
        # Deleting model 'ProyectoFotos'
        db.delete_table('mapeo_proyectofotos')
