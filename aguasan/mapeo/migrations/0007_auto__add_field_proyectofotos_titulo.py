...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProyectoFotos.titulo'
        db.add_column('mapeo_proyectofotos', 'titulo', self.gf('django.db.models.fields.CharField')(default='Foto', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProyectoFotos.titulo'
        db.delete_column('mapeo_proyectofotos', 'titulo')
