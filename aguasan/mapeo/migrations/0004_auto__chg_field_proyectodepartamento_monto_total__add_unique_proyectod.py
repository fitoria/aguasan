...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ProyectoDepartamento', fields ['proyecto', 'departamento']
        #db.create_unique('mapeo_proyectodepartamento', ['proyecto_id', 'departamento_id'])

        # Adding unique constraint on 'ProyectoDonante', fields ['proyecto', 'donante']
        db.create_unique('mapeo_proyectodonante', ['proyecto_id', 'donante_id'])

        # Adding unique constraint on 'ProyectoContraparte', fields ['proyecto', 'contraparte']
        db.create_unique('mapeo_proyectocontraparte', ['proyecto_id', 'contraparte_id'])

        # Adding unique constraint on 'ProyectoMunicipio', fields ['proyecto', 'municipio']
        db.create_unique('mapeo_proyectomunicipio', ['proyecto_id', 'municipio_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'ProyectoDepartamento', fields ['proyecto', 'departamento']
        db.delete_unique('mapeo_proyectodepartamento', ['proyecto_id', 'departamento_id'])

        # Removing unique constraint on 'ProyectoDonante', fields ['proyecto', 'donante']
        db.delete_unique('mapeo_proyectodonante', ['proyecto_id', 'donante_id'])

        # Removing unique constraint on 'ProyectoContraparte', fields ['proyecto', 'contraparte']
        db.delete_unique('mapeo_proyectocontraparte', ['proyecto_id', 'contraparte_id'])

        # Removing unique constraint on 'ProyectoMunicipio', fields ['proyecto', 'municipio']
        db.delete_unique('mapeo_proyectomunicipio', ['proyecto_id', 'municipio_id'])
