...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tipos on 'Proyecto'
        db.create_table('mapeo_proyecto_tipos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('proyecto', models.ForeignKey(orm['mapeo.proyecto'], null=False)),
            ('tipoproyecto', models.ForeignKey(orm['mapeo.tipoproyecto'], null=False))
        ))
        db.create_unique('mapeo_proyecto_tipos', ['proyecto_id', 'tipoproyecto_id'])

        

        # Deleting field 'Proyecto.tipo'
        #db.delete_column('mapeo_proyecto', 'tipo_id')

    def backwards(self, orm):
        
        # Adding field 'Proyecto.tipo'
        #db.add_column('mapeo_proyecto', 'tipo', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mapeo.TipoProyecto']), keep_default=False)

        # Removing M2M table for field tipos on 'Proyecto'
        db.delete_table('mapeo_proyecto_tipos')
