...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contraparte.descripcion'
        db.add_column('mapeo_contraparte', 'descripcion', self.gf('django.db.models.fields.TextField')(default=None, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contraparte.descripcion'
        db.delete_column('mapeo_contraparte', 'descripcion')
    ...
    models = {
        ...
        'mapeo.proyectomunicipio': {
            ...
            'contrapartes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mapeo.Contraparte']"}),
            'donantes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mapeo.Donante']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
