...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mapeo_contraparte', 'logo', self.gf('mapeo.thumbs.ImageWithThumbsField')(max_length=100, blank=True))

        # Changing field 'Proyecto.logo'
        db.alter_column('mapeo_proyecto', 'logo', self.gf('mapeo.thumbs.ImageWithThumbsField')(max_length=100, blank=True))

        # Changing field 'Donante.logo'
        db.alter_column('mapeo_donante', 'logo', self.gf('mapeo.thumbs.ImageWithThumbsField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Contraparte.logo'
        db.alter_column('mapeo_contraparte', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True))

        # Changing field 'Proyecto.logo'
        db.alter_column('mapeo_proyecto', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True))

        # Changing field 'Donante.logo'
        db.alter_column('mapeo_donante', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True))
    ...
    models = {
        ...
        'mapeo.contraparte': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('mapeo.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'mapeo.proyecto': {
            ...
            'tipos': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mapeo.TipoProyecto']", 'symmetrical': 'False'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
        },
        ...
        'mapeo.proyectomunicipio': {
            ...
            'contrapartes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['mapeo.Contraparte']", 'null': 'True', 'blank': 'True'}),
            'donantes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['mapeo.Donante']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
